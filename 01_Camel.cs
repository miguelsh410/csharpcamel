...
namespace Camel
{
  ...
  class CamelGame {
    ...
    public CamelGame() {
      distanceToTravel = rand.Next(40, 50);
    ...
    public void aheadModSpeed() {
      distanceTraveled += rand.Next(1, 6);
      nativesDistanceFromYou -= rand.Next(3, 10);
      hydrationLevel -= rand.Next(11, 18);
      energyLevel -= rand.Next(11, 18);
    }

    public void aheadFullSpeed() {
      distanceTraveled += rand.Next(5, 11);
      nativesDistanceFromYou -= rand.Next(7, 15);
      hydrationLevel -= rand.Next(15, 30);
      energyLevel -= rand.Next(15, 30);
    }
    ...
    public void statusReport() {
      Console.WriteLine("You need to travel " + (distanceToTravel - distanceTraveled) + " miles.");
      ...
      if (hydrationLevel < 31) Console.WriteLine("You are very thirsty!");
      if (energyLevel < 31) Console.WriteLine("You are very tired!");
    }
    ...
    public void checkIfGameIsOver() {
      if (distanceToTravel - distanceTraveled <= 0) {
        ...
        Console.WriteLine("You fainted because you were tired. You lose.");
        gameOver = true;
      }
    }
  }
